...
<div>
	<div style="max-width: 64rem; display: inline-block">
		...
		<div class="mt-16 text-left">
			{#if donateSection}
				...
				<div class="mt-4">
					...
					<div class="mt-8">
						...
						<p>
							<strong>Info:</strong> The "Come Back Alive Foundation" claims that donations are used
							for defensive gear only, not lethal equipment
						</p>
					</div>
				</div>
			{:else if actSection}
				...
				<div>
					...
					<p class="mt-4">
						...
						that help. They may collect food, blankets and other supply for Ukraine. Other groups are
						helping arriving refugees at airports and train stations of big cities (e.g. Berlin or Krakow).
					</p>
					<p class="mt-4">
					...
					<p class="mt-4">
						<strong>Demonstrate:</strong> Apply pressure on Russia on a global scale. Call for action
						of politics and companies. Help organizing peace protests and other actions. We can't stay
						quiet in these times.
					</p>
				</div>
			...
			{:else if boycottSection}
				...
				<p class="mt-4">
					Putin's war drains millions of dollars every minute. Upholding business operations in
				...
				<div class="mt-4 grid place-items-center lg:flex lg:justify-between lg:place-items-start">
					<div class="px-8 py-4 max-w-md rounded-lg bg-slate-200 lg:mr-12">
						<h3 class="text-lg text-center font-bold">Detailed & graphic overview</h3>
						<p class="mb-12 mt-4">
							The detail page is very graphic and <span class="font-bold"
								>good for sharing in social media</span
					...
					<div class="px-8 py-4 mt-12 max-w-md rounded-lg bg-slate-200 lg:mt-0">
						<h3 class="text-lg font-bold text-center">Quick overview</h3>
						<p class="mb-12 mt-4">
	...
	<div class="grid place-items-center mt-16 lg:flex lg:justify-center">
